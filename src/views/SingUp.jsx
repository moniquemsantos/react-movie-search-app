        ...
        <Grid>
            <Paper style={paperStyle}>
             ...
             <form>
                ...
                <TextField fullWidth variant="standard" label="Number" placeholder="Enter your number"/>
                <TextField fullWidth variant="standard" label="Password" placeholder="Enter your password" type="password" required/>
                <TextField fullWidth variant="standard" label="Confirm Password" placeholder="Enter your password" type="password" required/>
